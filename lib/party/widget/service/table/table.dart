...
class _tablwwidgetState extends State<tablwwidget> {
  ...
  Widget build(BuildContext context) {
     final _provider=Provider.of<Tableprovider>(context,listen: false);
    return  Container(
      ...
      child: PlutoGrid(
        ...
        //   //   addNewRow();
        //   // }
        //   ///remove row when button pressed
          
        //   if(_provider.issavebutton==true){RemoveEntireRows();}
        // },
